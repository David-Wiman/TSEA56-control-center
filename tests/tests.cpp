...
TEST_CASE("Control Center") {
    ...
    SECTION("Dijkstra from ControlCenter") {
        ...
        //// Solve
        //vector<instruction::InstructionNumber> drive_instructions = control_center.get_drive_instructions("H2");
        //// Tests
        //CHECK(control_center.get_current_drive_instruction() == instruction::forward);
    ...
    SECTION("Dijkstra from ControlCenter with list of drive missions") {
        ...
        CHECK(control_center.get_current_road_segment() == "??");
